    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                String name2 = (String) stock1.get("name");
                ...
                int change1 = 0;
                if (stock1.containsKey("change")) change1 = (int) stock1.get("change");
                else change1 = (int) stock1.get("last") - (int) stock1.get("open");

                int change2 = 0;
                if (stock2.containsKey("change")) change2 = (int) stock2.get("change");
                else change2 = (int) stock2.get("last") - (int) stock2.get("open");

                return (change2 - change1) * 1000;
            }
        });
    }
